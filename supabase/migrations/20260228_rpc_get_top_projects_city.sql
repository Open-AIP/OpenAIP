...
drop function if exists public.get_top_projects_for_barangays(
  int,
  int,
  uuid[]
);

create or replace function public.get_top_projects_for_barangays(
...
revoke all on function public.get_top_projects_for_barangays(
  int,
  int,
  uuid[]
) from public;
...
grant execute on function public.get_top_projects_for_barangays(
  int,
  int,
  uuid[]
) to authenticated;
