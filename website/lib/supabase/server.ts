...
export async function supabaseServer() {
  ...
  return createServerClient(url, publishableOrAnonKey, {
    cookies: {
      getAll() {
      ...
      setAll(cookiesToSet) {
        try {
          ...
          // Cookies cannot be written from Server Components.
          // Middleware/route handlers should handle session refresh persistence.
        }
      },
    },
  });
