...
create table if not exists public.projects (
  ...
  -- Only canonical prefixes map to a sector; null/invalid refs produce null sector.
  ...
  constraint uq_projects_key unique (aip_id, project_key),
...
-- =============================================================================
-- Phase 17 - Projects Updates + Media Baseline (2026-02-26)
-- Source migration: website/docs/sql/2026-02-26_projects_updates_and_media.sql
-- =============================================================================
...
-- =============================================================================
-- Phase 18 - Project Updates Moderation Hide/Unhide (2026-03-01)
-- Source migration: website/docs/sql/2026-03-01_project_updates_hide_unhide_and_feedback_author_visibility.sql
-- =============================================================================
...
-- =============================================================================
-- Phase 19 - Feedback Activity Log Citizen Coverage (2026-03-01)
-- Source migration: website/docs/sql/2026-03-01_feedback_activity_log_include_citizen.sql
-- =============================================================================
...
-- =============================================================================
-- Phase 20 - Citizen About-Us Content Settings Seed (2026-03-01)
-- Source migration: website/docs/sql/2026-03-01_citizen_about_us_content_settings.sql
-- =============================================================================
...
-- =============================================================================
-- Phase 21 - Citizen Dashboard Content Settings Seed (2026-03-01)
-- Source migration: website/docs/sql/2026-03-01_citizen_dashboard_content_settings.sql
-- =============================================================================
...
-- =============================================================================
-- Phase 22 - Embed Dispatch Signed Headers + Audience (2026-03-03)
-- Source migration: website/docs/sql/2026-03-03_embed_categorize_signed_dispatch.sql
-- =============================================================================
...
-- =============================================================================
-- Phase 23 - Notifications + Outbox + Preferences + RLS (2026-03-03)
-- Source migration: website/docs/sql/2026-03-03_notifications_outbox_tables_rls.sql
-- =============================================================================
...
-- =============================================================================
-- Phase 24 - Admin Pipeline Failure Notifications (2026-03-03)
-- Source migration: website/docs/sql/2026-03-03_notifications_admin_pipeline_outbox_alerts.sql
-- =============================================================================
...
-- =============================================================================
-- Phase 25 - Uploader Extraction Terminal Notifications (2026-03-06)
-- Source migration: website/docs/sql/2026-03-06_notifications_aip_uploader_terminal_status.sql
-- =============================================================================

begin;

-- =============================================================================
-- Uploader terminal notifications for extraction runs
-- - Emits uploader-facing notifications/emails when extraction_runs reaches:
--   succeeded or failed.
-- - Keeps admin PIPELINE_JOB_FAILED flow unchanged (separate trigger).
-- =============================================================================

drop function if exists public.emit_uploader_extraction_terminal_notifications();
