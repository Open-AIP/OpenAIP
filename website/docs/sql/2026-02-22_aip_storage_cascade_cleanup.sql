...
-- Best-effort Storage cleanup for hosted Supabase:
-- direct writes on storage.objects may be blocked by the platform.
-- If blocked, never fail the parent delete transaction.
...
-- Remove Storage objects for deleted extraction artifact rows.
