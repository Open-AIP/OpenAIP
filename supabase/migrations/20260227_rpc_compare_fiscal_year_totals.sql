...
drop function if exists public.compare_fiscal_year_totals(
  int,
  int,
  uuid
);

create or replace function public.compare_fiscal_year_totals(
  p_year_a int,
  p_year_b int,
...
revoke all on function public.compare_fiscal_year_totals(
  int,
  int,
  uuid
) from public;
...
grant execute on function public.compare_fiscal_year_totals(
  int,
  int,
  uuid
) to authenticated;
