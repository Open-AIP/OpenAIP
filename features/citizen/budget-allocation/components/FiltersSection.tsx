...
import type { BudgetAllocationFiltersVM, BudgetAllocationLguOptionVM } from "@/lib/types/viewmodels/citizen-budget-allocation.vm";
        ...
        <div className="grid gap-4 md:grid-cols-[1fr_1.2fr_1.4fr]">
          ...
          <div className="space-y-2">
            ...
            >
              ...
              <SelectContent>
                {filters.availableLGUs.map((option) => (
