...
export default function HeroBannerSection({ title, subtitle }: HeroBannerSectionProps) {
  return (
    <section className="relative overflow-hidden rounded-xl border border-slate-200 bg-gradient-to-br from-[#022437] via-[#0b3652] to-[#114b59] px-6 py-10 text-white shadow-xl md:px-10">
