  ...
  return (
    <Card className="border-slate-200 py-0 shadow-none">
      ...
      <CardContent className="space-y-4 pt-4">
        <div className="rounded-[10px] border border-blue-200 bg-blue-50 px-4 py-3 text-[12px] text-blue-900">
          <div className="flex items-center gap-2">
            <div className="flex h-7 w-7 items-center justify-center rounded-lg bg-blue-100 text-blue-600">
              <Clock className="h-4 w-4" />
            </div>
            <div>
              <div className="text-[24px] leading-7 font-semibold">{backlog.awaitingCount}</div>
        ...
        <div className="rounded-[10px] border border-amber-200 bg-amber-50 px-4 py-3 text-[12px] text-amber-900">
          <div className="flex items-center gap-2">
            ...
            <div>
              <div className="text-[24px] leading-7 font-semibold">{backlog.stuckCount}</div>
