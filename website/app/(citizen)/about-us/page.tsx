...
const referenceDocs = [
  { title: "DBM Primer Cover", source: "Source: DBM", href: "/mock/sample.pdf" },
  { title: "RA 7160", source: "Source: Official Code", href: "/mock/sample.pdf" },
  { title: "LBM No. 92, FY 2026", source: "Source: DBM", href: "/mock/sample.pdf" },
];
                ...
                <CardContent className="space-y-4 p-5">
                  ...
                  <motion.div className="space-y-3" variants={staggerContainer}>
                    {referenceDocs.map((doc) => (
                      <motion.div key={doc.title} className="rounded-xl border border-slate-200 bg-white p-4" variants={cardReveal}>
