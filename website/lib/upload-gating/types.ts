...
export enum ValidationCode {
  ...
  UPLOAD_INVALID_SIGNATURE = "UPLOAD_INVALID_SIGNATURE",
  UPLOAD_FILE_TOO_LARGE = "UPLOAD_FILE_TOO_LARGE",
  UPLOAD_TOO_MANY_PAGES = "UPLOAD_TOO_MANY_PAGES",
  UPLOAD_ENCRYPTED_PDF = "UPLOAD_ENCRYPTED_PDF",
  UPLOAD_CORRUPTED_PDF = "UPLOAD_CORRUPTED_PDF",
  UPLOAD_UNAUTHENTICATED = "UPLOAD_UNAUTHENTICATED",
  UPLOAD_FORBIDDEN_ROLE = "UPLOAD_FORBIDDEN_ROLE",
  UPLOAD_NO_LGU_SCOPE = "UPLOAD_NO_LGU_SCOPE",
  UPLOAD_INVALID_YEAR = "UPLOAD_INVALID_YEAR",
  UPLOAD_INVALID_UPLOADER_SCOPE = "UPLOAD_INVALID_UPLOADER_SCOPE",
  UPLOAD_DUPLICATE_FILE = "UPLOAD_DUPLICATE_FILE",
  UPLOAD_AIP_ALREADY_EXISTS = "UPLOAD_AIP_ALREADY_EXISTS",
  UPLOAD_NOT_ALLOWED_IN_STATE = "UPLOAD_NOT_ALLOWED_IN_STATE",
  UPLOAD_RATE_LIMITED = "UPLOAD_RATE_LIMITED",
  UPLOAD_SCANNED_PDF_NOT_SUPPORTED = "UPLOAD_SCANNED_PDF_NOT_SUPPORTED",
  UPLOAD_NOT_AIP_DOCUMENT = "UPLOAD_NOT_AIP_DOCUMENT",
  UPLOAD_YEAR_NOT_DETECTED = "UPLOAD_YEAR_NOT_DETECTED",
  UPLOAD_YEAR_MISMATCH = "UPLOAD_YEAR_MISMATCH",
  UPLOAD_LGU_NOT_DETECTED = "UPLOAD_LGU_NOT_DETECTED",
  UPLOAD_LGU_LEVEL_NOT_DETECTED = "UPLOAD_LGU_LEVEL_NOT_DETECTED",
  UPLOAD_LGU_LEVEL_MISMATCH = "UPLOAD_LGU_LEVEL_MISMATCH",
  UPLOAD_LGU_MISMATCH = "UPLOAD_LGU_MISMATCH",
  UPLOAD_TEMPLATE_COLUMNS_MISSING = "UPLOAD_TEMPLATE_COLUMNS_MISSING",
  UPLOAD_NO_PROJECT_ROWS = "UPLOAD_NO_PROJECT_ROWS",
  UPLOAD_IMPLAUSIBLE_CONTENT = "UPLOAD_IMPLAUSIBLE_CONTENT",
  UPLOAD_INTERNAL_VALIDATION_ERROR = "UPLOAD_INTERNAL_VALIDATION_ERROR",
}
